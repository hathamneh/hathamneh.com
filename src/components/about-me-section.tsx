...
export const AboutMeSection = () => {
	return (
		<Section
			id="about"
			contentClassName="flex flex-col xl:flex-row gap-4"
			className="my-10"
		>
			<div className="flex-1 xl:mb-0 mb-20">
				<h4 className="text-primary font-bold uppercase text-xl">About Me</h4>
				<div className="text-[36px] font-bold">Curious, Passionate</div>
			...
			<div className="">
				...
				<p className="my-3">
					You can find me on the social media platforms below:
				</p>
